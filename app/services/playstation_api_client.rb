...
class PlaystationApiClient
  ...
  def my_trophy_titles
    res = RestClient::Request.execute(
      ...
      headers: {
        params: { limit: 800 }, # the max possible value; I will not handle pagination for now because it is largely enough for me
  ...
  def my_earned_trophies(title_id, service_name, group_id)
    res = RestClient::Request.execute(
      method: :get,
      url: "#{TROPHY_URL}/users/me/npCommunicationIds/#{title_id}/trophyGroups/#{group_id}/trophies",
      headers: {
